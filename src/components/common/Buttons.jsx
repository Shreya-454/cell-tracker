...
const Buttons = (props) => {
  return (
      ...
      <button aria-label="name"
        className={`${props.name} font-semibold sm:text-base text-sm !!leading-lg text-white sm:h-[59px] py-[14px] md:py-4 px-7 after:absolute  after:top-0 after:bottom-0
