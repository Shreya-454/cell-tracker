...
const Head = () => {
  return (
    <div id='home' className='bg-[url(./assets/images/Herobg.webp)] bg-cover bg-center bg-no-repeat xl:min-h-[810px] max-sm:min-h-[810px] flex flex-col relative z-[1]'>
      <NavBar/>
...
<div className="md:w-1/2 w-full px-3 relative flex justify-center">
  <img src={mobile} alt="mobile"  className=' sm:!-translate-x-20 xl:w-[581.42px] xl:h-[604.64px]  !-translate-x-12' data-aos="fade-left"/>
    <div data-aos="zoom-in-up" className=' lg:max-w-[280.07px] sm:max-w-[231px] max-w-[164px] p-2 md:p-[18px] bg-[#ffffff] absolute w-full md:top-[43%] right-[5%] top-[52%]  md:right-[3%] md:h-[196.95px] shadow-[0px_0px_24.6px_0px_#00000059] md:rounded-tl-xl rounded-tl-lg md:rounded-br-xl rounded-br-lg
'>
...
<Buttons text='Customer Support' name='!py-2 rounded lg:text-base text-sm !px-0 w-full sm:!h-[59px]  '/>
      ...
      <img src={bottomLayer} alt="layer" className='lg:bottom-[-14%]  bottom-[-4%] w-full absolute z-[-1] max-sm:h-[97px]' />
    </div>
  );
}
