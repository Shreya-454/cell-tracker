        ...
        <div className="container max-w-[1164px] ">
          <div className="flex flex-row flex-wrap -mx-3 items-center">
            <div className="w-1/2 px-3">
              <h1 className=" text-white text-6xxl leading-full font-light max-w-[520px] mb-2">
            ...
            <div className="w-1/2 px-3 relative">
              ...
              <div
                className=" max-w-[280.07px] p-[18px] bg-[#ffffff] absolute w-full top-[44%] right-[1%] shadow-[0px_0px_24.6px_0px_#00000059] rounded-tl-xl rounded-br-xl
"
              >
                <div className="flex justify-between items-center">
                  <p className=" text-skyBlue text-2xl leading-lg font-bold">
                    Need help?
                  </p>
                  <Help />
                </div>
                <p className=" text-darkBlue text-base font-normal max-w-[198px] mb-[14px]">
