...
const Find = () => {
  return (
    <div className=" mt-[273px] lg:mt-52 pt-2 max-xl:px-6 overflow-x-clip">
          <div className="container rounded-xl bg-no-repeat lg:max-h-[391px] bg-cover bg-center max-w-[1140px] bg-find max-sm:px-[30.5px]">
    ...
    <div className="lg:w-7/12 w-full px-3 lg:py-[98px] max-lg:-mt-40  max-lg:pb-[46px] ">
      ...
      <div className=" flex justify-center">
        <Buttons text="Start Now" name="!text-darkBlue !bg-white max-sm:w-full"/>
      </div>
    </div>
              </div>
      </div>
