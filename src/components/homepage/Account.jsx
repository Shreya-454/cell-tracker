...
const Account = () => {
  return (
    <div className=' pt-[98px] pb-[93.28px] relative z-[1]'>
        <img src={accountVector1} alt="vector" className=' absolute left-0 md:top-[15%] top-[2%] z-[-1] max-sm:w-[41px]' />
        <img src={accountVector2} alt="vector" className=' absolute right-0 sm:bottom-[15%] bottom-[1%] z-[-1] max-sm:w-[41px]' />
...
<h3 className=' md:text-3xxl text-2xxl leading-sm text-darkBlue font-light mb-6'>Get a <span className=' font-extrabold'>24 hour</span> trial!</h3>
    <div>
...
<div className=' flex justify-center lg:block'>
    <div className=' lg:max-w-[424px] max-w-[700px] w-full shadow-[0px_0px_9.5px_0px_#00000014] p-[18px]
    '>
    ...
    ">
        <div className="flex justify-between items-center md:px-5 px-2 md:py-[15px] py-[24.5px] bg-darkBlue">
            ...
            <div className="flex sm:gap-[34px] gap-[6px] items-center">
                <img src={visa} alt="visa"  className=' max-sm:!w-[27.77px]'/>
                <div className='flex flex-col items-center '>
<img src={mastercard} alt="card" className=' max-sm:!max-w-[23.97px]' />
<p className=' text-white sm:text-xs text-[5.14px] leading-sm'>mastercard</p>
                </div>
            </div>
        </div>
...
<input type="text" id='address' placeholder='Address Line 1'  className=' max-sm:!pl-5 text-darkBlue bg-[#FAFAFA] w-full p-[14px] focus:outline-none placeholder:text-darkBlue md:text-base text-sm md:placeholder:text-base placeholder:text-sm ' />
    ...
    <label htmlFor="email" className=' text-darkBlue md:text-base text-sm '>Email Address</label>
    <div className=' bg-[#FAFAFA] mt-2 border border-solid border-[#03045E0F] rounded flex overflow-hidden h-[52px] md:mb-5 mb-[18px]'>
<div className=' bg-[#EDEDED] max-w-12 w-full h-full flex justify-center items-center '>
   <EmailIcon/>
</div>
<input type="text" id='email' placeholder='Email Address'  className=' text-darkBlue bg-[#FAFAFA] w-full max-sm:!pl-5 p-[14px] focus:outline-none placeholder:text-darkBlue md:text-base text-sm md:placeholder:text-base placeholder:text-sm ' />
    </div>
...
<input type="text" id='card' placeholder='Valid Card Number'  className=' text-darkBlue max-sm:!pl-5 bg-[#FAFAFA] w-full p-[14px] focus:outline-none placeholder:text-darkBlue md:text-base text-sm md:placeholder:text-base placeholder:text-sm ' />
    </div>
    <div className=' flex w-full gap-[17px] md:mb-[46px] mb-[38px]'>
        <div className="w-1/2">
            <label htmlFor="date" className=' text-darkBlue md:text-base text-sm'>
            Expiry Date
            </label> <div className=' bg-[#FAFAFA] mt-2 border border-solid border-[#03045E0F] rounded flex overflow-hidden h-[52px] '>
<div className=' bg-[#EDEDED] max-w-12 w-full h-full flex justify-center items-center '>
<Calender/>
</div>
<input type="text" id='date' placeholder='MM/YY'  className=' text-darkBlue max-sm:!pl-5 w-full p-[14px] bg-[#FAFAFA] focus:outline-none placeholder:text-darkBlue md:text-base text-sm md:placeholder:text-base  placeholder:text-sm' />
    </div>
...
<input type="text" id='password' placeholder='E.x @ 0123'  className=' text-darkBlue max-sm:!pl-5 w-full p-[14px] bg-[#FAFAFA] focus:outline-none placeholder:text-darkBlue md:text-base text-sm md:placeholder:text-base placeholder:text-sm ' />
    </div>
