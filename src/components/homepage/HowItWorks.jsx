  ...
  return (
    <div className=" sm:pt-12 pb-16 relative z-[1]">
      <div className="container max-w-[1140px] mx-auto sm:px-3 px-6">
        ...
        <p className="md:pt-2 pt-3 lg:mb-24 md:mb-20 mb-10 text-center text-lightBlack sm:max-w-[472px] max-w-[278px] mx-auto sm:text-base text-sm font-normal">
          Fames tincidunt pellentesque nisl blandit at sit. Ullamcorper nisi sit
          elit rhoncus vestibulum fames libero id.
        </p>
        <div className="flex flex-row flex-wrap -mx-3">
          <div className="lg:w-1/2  w-full px-3 relative z-[1] flex justify-center lg:block max-lg:overflow-x-clip ">
            ...
            <div className=" xl:w-[569px] md:w-[569px] w-[349.54px] sm:w-[500px] max-sm:top-[-10%] lg:w-[500px] lg:h-[420px] h-[348.9px] sm:h-[420px] md:h-[490.95px] xl:h-[490.95px] bg-ellipse absolute animate-wiggle4 left-[2%] sm:left-[13%] lg:left-[2%] xl:left-[-7%] z-[-1]"></div>
        ...
        <div className="sm:flex max-sm:flex-col xl:mt-10 md:mt-9 mt-[42px] justify-center sm:gap-[14px]">
