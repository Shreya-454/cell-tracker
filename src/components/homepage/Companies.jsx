...
">
                    ...
                    <p className=' sm:text-base text-sm font-normal text-lightBlack mb-3'>Ideal for freelancers and solopreneurs</p>
                    <div className=' flex  gap-[6px] items-center mb-[6px]'>
                        <Check/>
                        <p className=' text-lightBlack sm:text-base text-sm'>1 seat</p>
                    </div>
                    <div className=' flex  gap-[6px] items-center mb-11'>
                        <Check/>
                        <p className=' text-lightBlack sm:text-base text-sm'>2 projects</p>
                    </div>
          <p className=' sm:text-base text-sm font-normal text-lightBlack mb-[27px]'><span className=' md:text-4xxl text-3xl leading-md text-darkBlue'>$0</span> free forever</p>
...
<p className=' sm:text-base text-sm text-lightBlack font-normal mb-3'>Perfect for teams, startups, and growing businesses.</p>
<div className=' flex gap-[6px] items-center'>
    <Check/>
    <p className=' text-lightBlack sm:text-base text-sm font-normal'>Unlimited seats</p>
</div>
<div className=' flex gap-[6px] items-center mb-11'>
    <Check/>
    <p className=' text-lightBlack sm:text-base text-sm font-normal'>Unlimited projects</p>
</div>
...
<Buttons text="30-Day Free Trial" name="!font-normal max-md:w-full"/>
    <p className=' sm:text-base text-sm text-lightBlack font-normal'>No credit card required.</p>
</div>
</div>
            </div> 
        </div>
