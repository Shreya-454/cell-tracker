...
">
          ...
          <button className=' bg-darkBlue text-white py-4 px-7 rounded leading-lg md:text-base text-sm '>Start your free trial</button>
                </div>
                <div className="max-w-[527px] lg:!order-2 !order-1 w-full bg-white shadow-[0px_16px_25.3px_0px_#00000014] relative rounded-tl-xl rounded-br-xl lg:-translate-x-6 sm:pt-[60px] md:pt-[76px] px-6 pb-[30px] sm:px-[34px] sm:pb-[34px]
">
